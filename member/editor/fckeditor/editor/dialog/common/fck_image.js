...
function UpdateImage( e, skipId )
{
	...
	if(GetE('txtWidth').value > 0) SetAttribute( e, "width" , GetE('txtWidth').value ) ;//AIJIACMS ADD
	if(GetE('txtHeight').value > 0) SetAttribute( e, "height", GetE('txtHeight').value ) ;//AIJIACMS ADD
