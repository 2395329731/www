...
class ChinesePinyin{
	...
	public function __construct(){
		if( empty($this->ChineseCharacters) ){
		  $this->ChineseCharacters = file_get_contents(AJ_ROOT.'/file/table/ChineseCharacters.dat');	
		}
	}
	//$ipfile = AJ_ROOT.'/include/ChineseCharacters.dat';
	/*
	* 转成带有声调的汉语拼音
