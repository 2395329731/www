									...
									delay = setTimeout(function() {
										$.ajax({
											...
											if (data.length > 0) {
												l = data.length;
												for (; i < l; i++) {
													html += '<li data-val="'+data[i].hid+'"><b>' + data[i].name + '</b><span> ' + data[i].address + '</span><t style="display:none;"> ' + data[i].map + '</t><strong style="display:none;"> ' + data[i].areaid + '</strong></li>';
												}
											}
