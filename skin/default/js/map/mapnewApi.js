...
mapApi.prototype.openWin=function(marker,e){
	...
	winStr+='<div class="wincont"><div class="win_c_r"><a href="'+marker.href+'" target="_blank"><img src="'+marker.imgsrc+'" width="160" height="120"></a><br /><a href="'+marker.href+'" target="_blank">查看楼盘详情?</a></div><div class="win_c_l"><ul><li>均价：'+it_price+'</li><li>开盘时间：'+marker.selltime+'</li><li>物业类型：'+marker.protype+'</li><li>项目地址：'+marker.hseat+'</li><li>开发商：'+marker.emplor+'</li><li>销售电话：<b>'+marker.tel+'</b></li></ul></div></div>';
	winStr+='</div>';
