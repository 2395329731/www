...
<div class="b5 c_b"> </div>
<div><a href="<?php echo AJ_PATH;?>api/redirect.php?mid=<?php echo $v['item_mid'];?>&itemid=<?php echo $v['item_id'];?>" target="_blank"><img src="admin/image/link.gif" width="16" height="16" title="点击打开原文" alt="" align="absmiddle"/></a> <a href="<?php echo AJ_PATH;?>api/redirect.php?mid=<?php echo $v['item_mid'];?>&itemid=<?php echo $v['item_id'];?>" target="_blank"><?php echo $v['item_title'];?></a></div>
<div class="b5 c_b"> </div>
