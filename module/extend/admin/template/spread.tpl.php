...
<option value="6"<?php if($mid == 6) echo ' selected';?>>新房</option>
<option value="5"<?php if($mid == 5) echo ' selected';?>>二手房</option>
<option value="7"<?php if($mid == 7) echo ' selected';?>>租房</option>
<option value="16"<?php if($mid == 16) echo ' selected';?>>求购</option>
