...
<script type="text/javascript" src="<?php echo AJ_PATH;?>api/swfupload/swfupload.queue.js"></script>
<script type="text/javascript" src="<?php echo AJ_PATH;?>api/swfupload/swfupload.speed.js"></script>
<script type="text/javascript" src="<?php echo AJ_PATH;?>api/swfupload/handlers_video.js"></script>
<script type="text/javascript">
	...
	//window.onload = function() {
		var settings = {
			...
			upload_url: UPPath,
			post_params: {"from": "file", "width": "100", "height": "100", "swf_userid": "<?php echo $_userid;?>", "swf_username": "<?php echo $_username;?>", "swf_groupid": "<?php echo $_groupid;?>", "swf_company": "<?php echo $_company;?>", "swf_auth": "<?php echo md5($_userid.$_username.$_groupid.$_company.AJ_KEY.$AJ_IP);?>", "swfupload": "1"},
			...
			// Button settings
			button_image_url: "<?php echo AJ_PATH;?>api/swfupload/upload1.png",
			button_width: "34",
			button_height: "20",
