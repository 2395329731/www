...
if(in_array($action, array('', 'check'))) {
	$sfields = array('按条件', '公司名', '会员名', '昵称','姓名', '手机号码', '部门', '职位', 'Email', 'QQ', 'MSN', '阿里旺旺', 'Skype', '注册IP', '登录IP', '客服专员', '开户银行', '银行帐号', $AJ['trade_nm'], '推荐人', '备注');
...
switch($action) {
	...
	case 'passport':
		...
		$user = $db->get_one("SELECT * FROM {$AJ_PRE}member WHERE passport='$cpassport'");
