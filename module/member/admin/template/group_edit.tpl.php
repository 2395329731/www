...
<td><input type="text" size="2" name="setting[discount]" id="discount" value="<?php echo $discount;?>"/> % <span class="f_gray">折扣仅限系统收费，不针对会员房源</span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 交易佣金</td>
<td><input type="text" size="2" name="setting[commission]" id="commission" value="<?php echo $commission;?>"/> % <span class="f_gray">会员通过团购完成交易后，系统扣除交易额一定比例作为网站服务费用</span></td>
</tr>
<tr>
...
<td>
<input type="text" name="setting[message_limit]" size="5" value="<?php echo $message_limit;?>"/> <?php echo tips('咨询和报价为特殊的站内信，发送一次咨询或者报价会消耗一次站内信发送机会');?>
</td>
</tr>

<tr>
<td class="tl">每日咨询次数限制</td>
<td>
