...
<td><a href="house/<?php echo $v['houseid'];?>/" target="_blank"><?php echo $v['housename'];?></a></td>
...
<td>
<a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&action=item&itemid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 图片列表');">图片列表</a>&nbsp;
