...
switch($action) {
	...
	case 'move':
		if($submit) {
			...
			if($type == 1) {
				$ftb = $AJ_PRE.'sale_5';
				$ftb_data = $AJ_PRE.'sale_data_5';
				$fmid = 5;
				$ttb = $AJ_PRE.'rent_7';
				$ttb_data = $AJ_PRE.'rent_data_7';
				$tmid = 7;
			} else if($type == 2) {
				$ftb = $AJ_PRE.'newhouse_6';
				$ftb_data = $AJ_PRE.'newhouse_data_6';
				$fmid = 6;
				$ttb = $AJ_PRE.'sale_5';
				$ttb_data = $AJ_PRE.'sale_data_5';
				$tmid = 5;
			} else if($type == 5) {
				$ftb = $AJ_PRE.'sale_5';
				$ftb_data = $AJ_PRE.'sale_data_5';
				$fmid = 5;
				$ttb = $AJ_PRE.'newhouse_6';
				$ttb_data = $AJ_PRE.'newhouse_data_6';
				$tmid = 6;
			} else if($type == 6) {
				$ftb = $AJ_PRE.'rent';
				$ftb_data = $AJ_PRE.'rent_data_7';
				$fmid = 7;
				$ttb = $AJ_PRE.'sale_5';
				$ttb_data = $AJ_PRE.'sale_data_5';
				$tmid = 5;
