...
<div class="tt">CMS系统表[共<?php echo $dtotalsize;?>M,<?php echo count($dtables);?>个表]</div>
...
<td><a href="?file=<?php echo $file;?>&action=repair&table=<?php echo $v['name'];?>">修复</a> | <a href="?file=<?php echo $file;?>&action=optimize&table=<?php echo $v['name'];?>">优化</a></td>
</tr>
<?php }?>
</table>
<?php if($tables) {?>
