...
&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value=" 更 新 " onclick="if(_del && !confirm('提示:您选择删除'+_del+'个房源类型？确定要删除吗？')) return false;" class="btn"/>
</td>
</tr>
</table>
</form>
...
<tr>
<td>
&nbsp;源房源ID：<input type="text" size="5" name="fpid" id="fpid"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
目标房源ID：<input type="text" size="20" name="tpid" id="tpid"/>&nbsp;
...
1、如果一个房源属于多个分类，首先按分类多次添加此房源，然后在任意一个同名房源下建立属性，属性建立之后，可以做为源房源ID将属性同步到其他指定的目标房源。<br/>
2、目标房源ID如果有多个，请用英文逗号(,)分隔开。目标房源没有而源房源有的属性，将被创建；目标房源和源房源同名的属性，将被更新。
</td>
</tr>
</table>
</form>
