...
<tr>
<td class="tl">网站地址</td>
<td><input name="config[url]" type="text" value="<?php echo $url;?>" size="40"/><?php tips('请添写完整URL地址,例如http://www.aijiacms.com/<br/>注意以 / 结尾');?></td>
</tr>
<tr>
...
<td><input name="setting[remote_url]" type="text" value="<?php echo $remote_url;?>" size="60"/><?php tips('例如 http://static.aijiacms.com/，注意以 / 结尾');?></td>
</tr>
<tr> 
...
<img src="<?php echo AJ_SKIN;?>image/mobile.gif" align="absmiddle"/> <a href="http://www.winic.org/" target="_blank" class="t">[申请帐号]</a>
</td>
</tr>
...
<td>
<span class="f_red" >
<?php echo file_get_contents("http://service.winic.org/webservice/public/remoney.asp?uid=$sms_uid&pwd=$smskey");?>
</span> 元 <a href="http://www.winic.org/" target="_blank" class="t">[在线充值]</a></td> 
</tr>
<?php } ?>
