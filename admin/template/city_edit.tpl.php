...
<tr>
<td class="tl"><span class="f_hid">*</span> 设置为默认城市</td>
<td><input name="post[hits]" type="checkbox" value="1" <?php if($hits){ ?>checked="CHECKED" <?php } ?> >
(单城市版,设置无效)</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> baidu地图坐标设置</td>
<td><input name="post[map_mid]" type="text" id="map_mid" value="<?php echo $map_mid;?>" size="41">&nbsp;&nbsp;<a href="http://dev.baidu.com/wiki/static/map/API/tool/getPoint/" target="_blank" >拾取地图坐标</a></td>
</tr>
</table>
