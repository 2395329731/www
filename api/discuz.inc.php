...
if($action == 'login') {
	$txt = "time=$AJ_TIME&cookietime=$cookietime&username=$passport&password=$password&secques=".substr(md5(random(8)), 16, 8)."&gender=$gender&email=$email&regip=$regip&regdate=$regtime&oicq=$qq&msn=$msn&showemail=0";
