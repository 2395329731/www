...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.tenpay.com" target="_blank" class="t"><strong>财付通 TenPay</strong></a></td>
<td>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://pay.weixin.qq.com/" target="_blank" class="t"><strong>微信支付 Wechat</strong></a></td>
<td>
<input type="radio" name="pay[weixin][enable]" value="1"  <?php if($weixin['enable']) echo 'checked';?> onclick="Dd('weixin').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[weixin][enable]" value="0"  <?php if(!$weixin['enable']) echo 'checked';?> onclick="Dd('weixin').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://mp.weixin.qq.com/" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.alipay.com" target="_blank" class="t"><strong>支付宝 Alipay</strong></a></td>
<td>
<input type="radio" name="pay[alipay][enable]" value="1"  <?php if($alipay['enable']) echo 'checked';?> onclick="Dd('alipay').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[alipay][enable]" value="0"  <?php if(!$alipay['enable']) echo 'checked';?> onclick="Dd('alipay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://b.alipay.com/order/productDetail.htm?productId=2015110218012942" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.chinabank.com.cn" target="_blank" class="t"><strong>网银在线 ChinaBank</strong></a></td>
<td>
...
<input type="radio" name="pay[chinabank][enable]" value="0"  <?php if(!$chinabank['enable']) echo 'checked';?> onclick="Dd('chinabank').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.chinabank.com.cn" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.yeepay.com" target="_blank" class="t"><strong>易宝支付 YeePay</strong></a></td>
<td>
<input type="radio" name="pay[yeepay][enable]" value="1"  <?php if($yeepay['enable']) echo 'checked';?> onclick="Dd('yeepay').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[yeepay][enable]" value="0"  <?php if(!$yeepay['enable']) echo 'checked';?> onclick="Dd('yeepay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.yeepay.com" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.99bill.com" target="_blank" class="t"><strong>快钱支付 99bill</strong></a></td>
<td>
...
<input type="radio" name="pay[kq99bill][enable]" value="0"  <?php if(!$kq99bill['enable']) echo 'checked';?> onclick="Dd('kq99bill').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.99bill.com" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.chinapay.com" target="_blank" class="t"><strong>中国银联 ChinaPay</strong></a></td>
<td>
...
<input type="radio" name="pay[chinapay][enable]" value="0"  <?php if(!$chinapay['enable']) echo 'checked';?> onclick="Dd('chinapay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.chinapay.com" target="_blank" class="t">[帐号申请]</a> <?php tips('本接口需要 mcrypt 和 bcmath 两个PHP扩展库的支持，请先确认您安装并启用了这两个库');?>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.paypal.com" target="_blank" class="t"><strong>贝&nbsp;&nbsp;&nbsp;宝 PayPal</strong></a></td>
<td>
