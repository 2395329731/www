...
$_input_charset = AJ_CHARSET;		//字符编码格式  目前支持 GBK 或 utf-8
...
$notify_url = AJ_PATH.'api/pay/'.$bank.'/'.($PAY[$bank]['notify'] ? $PAY[$bank]['notify'] : 'notify.php');	// 异步返回地址
$return_url = $receive_url;		//同步返回地址
$show_url   = AJ_PATH;		//你网站商品的展示地址,可以为空
?>