...
switch($action) {
	...
	case 'answer':
		...
		if(isset($_POST['ok'])) {
			...
			$db->query("INSERT INTO {$table}_answer (qid,content,username,addtime,ip,status) VALUES ('$itemid', '$content', '$_username', '$AJ_TIME', '$AJ_IP', '$status')");			
		...
		$head_title = $L['know_title'].$AJ['seo_delimiter'].$head_title;
		$foot = '';
